...
export class LightBulbAccessory {
  ...
  constructor(
    ...
    //this.service.setCharacteristic(this.platform.Characteristic.On, accessory.context.device.props.on);
  ...
  async getOn(): Promise<CharacteristicValue> {
    ...
    const { data: state } = await axios.get(`https://api.freedompro.eu/api/freedompro/accessories/${this.uid}/state`, {
      headers: { 'Authorization': `Bearer ${this.platform.config.apiKey}` },
    });
